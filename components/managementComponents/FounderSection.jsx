...
const FounderSection = () => {
  return (
    <AnimateOnScroll animation="fadeInUp" duration={1.2} delay={0.2}>
        ...
        <div className="flex flex-col lg:flex-row-reverse">
          ...
          <div className="flex-1 p-5 lg:p-12">
            ...
            <p className="text-gray-600 leading-relaxed text-sm lg:text-lg mb-8">
              ...
              labore dol magna aliqua. olabisi oanbanjo university Ut enim ad
              minim Lorem ipsum eiusmod temp incididunt ut labore et dolore magna
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
              >
                <svg
                  className="w-5 h-5 text-white"
                  fill="currentColor"

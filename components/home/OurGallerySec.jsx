  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-15 mx-20">
          {galleryImages.map((image, index) => (
            <AnimateOnScroll 
              ...
              delay={0.4 + index * 0.2}
            >
              <div className="relative h-64 md:h-72  overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
                <Image
                  src={image.src}
                  alt={image.alt}
                  fill
        ...
        {/* View All Button */}
        <AnimateOnScroll animation="fadeInUp" duration={1} delay={1}>
